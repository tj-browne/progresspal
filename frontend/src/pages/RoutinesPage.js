...
const RoutinesPage = () => {
    ...
    const handleEdit = (routineId) => {
        navigate(`/routine/${routineId}`); // Navigate to the routine page
    };
        ...
        <div className="bg-gray-900 min-h-screen flex flex-col">
            ...
            <div className="flex flex-col items-center pt-32 flex-grow gap-7 text-white mb-32">
                ...
                {routines.length > 0 ? (
                        ...
                        >
                            <div className="flex items-center justify-between relative z-10">
                                ...
                                <HamburgerMenu
                                    ...
                                    onEdit={() => handleEdit(routine.id)} // Pass handleEdit to HamburgerMenu
                                        ...
                                        {routine.routine_exercises.map((exerciseEntry, index) => {
                                            ...
                                            return (
                                                <li className="mb-2" key={index}>
                                                    ...
                                                    <div>
                                                        {default_sets !== null && (
                                                            <p className="text-white">Sets: {default_sets}</p>
                                                        )}
                    ...
                    <p className="text-white">No routines available.</p>
                )}
