    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-900">
            ...
            <div className="flex flex-col justify-center align-center gap-7 text-center">
                <a href="/login" className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mr-2 text-2xl w-40">Log
                    in</a>
                <a href="/signup" className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded text-2xl w-40">Sign
                    up</a>
            </div>
        </div>
    )
